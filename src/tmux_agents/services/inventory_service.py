    ...
    *,
    ...
    for ds in discovered:
        ...
        if socket_filter and ds.ref.socket_name != socket_filter:
            continue
        runner = CommandRunner(socket_path=ds.ref.socket_path)
...
def inspect_pane(
    ...
    *,
    ...
    """
    inventory = get_inventory(config, socket_filter=socket_filter)
...
def preview_pane(
    ...
    *,
    ...
    """
    snap = inspect_pane(pane_id, config, socket_filter=socket_filter)
